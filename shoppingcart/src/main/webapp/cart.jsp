...
if(cart_list != null){
	...
	double total=pDao.getToatlCartPrice(cart_list);
				...
				for(Cart c:cartProduct){ %>
					...
					<td>
						<form action="order-now" method="post" class="form-inline">
							...
							<div class="form-group d-flex justify-content-btween w-50">
								<a class="btn btn-sm btn-derce" href="quantity-inc-dec?action=dec&id=<%= c.getId()%>">
